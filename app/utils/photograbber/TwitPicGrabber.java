...
/**
 * This is PhotoGrapper for Twitpic.
 * 
...
public class TwitPicGrabber extends TweetPhotoGrabberAbs {
    ...
    protected void grab() {
        ...
        try {
            ...
            if (el == null) {
                Logger.warn("Cannot find element photo-display from URL %1s", tweetPhotoURL);
                return;
            }
            ...
            Logger.error(e, "Failed getting photo from twitpic using URL %1s", tweetPhotoURL);
        }
    }
